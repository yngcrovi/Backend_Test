...
from src.repository.db_repo.service.product_service.product_service import product_service
from src.repository.db_repo.service.product_service.product_filter_model import operation_filter
from src.filter_list.filter_list import filter_list
...
async def filter(
    ...
    list_filter = filter_list(filter_data)
